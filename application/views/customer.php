          ...
          <div class="box">
              ...
              <div class="box-body table-responsive">
                <table id="example2" class="table table-bordered table-hover">
                  <thead>
                  <tr>
                    <th style="display:none">ID Pemesanan</th>
                    ...
                    <?php
                      $i;
                      foreach($listPesananCustomer->result() as $row){
                    ?>
                      <tr>
                        <td style="display:none"><?= $row->id_order ?></td>
                  ...
                  <tfoot>
                    <tr>
                      <td style="display:none">ID Pemesanan</th>
                      <th>Tanggal Laundry</th>
                      <th>Jenis Laundry</th>
                      <th>Isi Satuan Laundry</th>
                      <th>Total Berat Laundry</th>
