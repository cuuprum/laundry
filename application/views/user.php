  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="<?php echo base_url('user_pesanan');?>"><i class="fa fa-list"></i> <span>Laundry Saya</span></a></li>
        <li><a href="<?php echo base_url('user_order');?>"><i class="fa fa-plus-square"></i> <span>Order Laundry</span></a></li>                            
      </ul>
      <!-- /.sidebar-menu -->
    </section>
    <!-- /.sidebar -->
